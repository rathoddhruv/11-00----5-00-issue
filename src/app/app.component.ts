...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.zone.runOutsideAngular(() => {
      ...
      let consumptionState = series0.columns.template.states.create('hover');
      ...
      series0.yAxis = axis0;
      series0.columns.template.propertyFields.strokeDasharray = 'dashLength';
      ...
      series0Past.columns.template.cursorOverStyle = MouseCursorStyle.pointer;
      series0Past.sequencedInterpolation = false;
      series0Past.dataFields.valueY = 'series0Past';
      ...
      series1Past.dataFields.valueY = 'series1Past';
      series1Past.dataFields.dateX = 'time';
      series1Past.yAxis = axis1;
      series1Past.name = 'series1Past';
